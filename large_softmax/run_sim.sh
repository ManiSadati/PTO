...
# Direct A5 camodel run for the large softmax CCE kernel.
#
...
#
# Usage:
#   bash -ic 'activate_ptoas >/dev/null; cd ~/mani-PTO/large_softmax; bash run_sim.sh'
...
echo
echo "Large softmax camodel workflow completed successfully."
