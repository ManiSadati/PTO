...
constexpr int kSoftmaxGroupsPerBlock = 16;
constexpr int kSoftmaxLength = 8192;
...
static_assert(kElementsPerBlock == 131072,
              "The device kernel expects 131072 FP16 elements per block.");
